...
#		commandline can be specified through environment variable ANT_ARGS. For
...
# Build variables
product_name=$(VERSION_PRODUCT_RMJS)
version_str=$(VERSION_MAJOR_RMJS).$(VERSION_MINOR_RMJS).$(VERSION_MAINTENANCE_RMJS).$(VERSION_PATCH_RMJS)
